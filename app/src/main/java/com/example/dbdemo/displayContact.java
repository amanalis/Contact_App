    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MyDBHandler db = new MyDBHandler(displayContact.this);
                ...
                Toast.makeText(displayContact.this, "Contact updated!", Toast.LENGTH_SHORT).show();
                Log.d("dbaman", "affectedRows are: " + affectedRows);

                Intent intent = new Intent(displayContact.this, MainActivity.class);
